        ...
        <div class="row">
            <div class="panel1">
                <div class="panel-heading"><i class="fas fa-shopping-cart"></i> | ORDER OBAT HEWAN</div>
                    ...
                    <?php } ?>
                    <form method="post" action="<?php echo base_url('Order/order_obat'); ?>" name="formorder">
                        <div class="form-group row">
                            <label for="formGroupExampleInput2"class="col-sm-2 col-form-label">Product</label>
                            <div class="col-sm-10">
                                <select id="obat" class="form-control" name="produk" value="<?php echo $d->nama_obat?>"onFocus="startCalc()" onBlur="stopCalc()" >
                                    <option selected>PILIH PRODUCT</option>
                                    <?php $no = 1;
                                    foreach ($data as $d) { ?>                                                            
                                        <option value="<?php echo $d->harga?>" nama_barang="<?php echo $d->nama_obat?>"><?php echo $d->nama_obat?></option>
                                    <?php } ?>
...
// ambil nilai
var nama = $("#obat option:selected").attr("nama_barang");
